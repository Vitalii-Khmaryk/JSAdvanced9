...
describe('ProductService', () => {
  ...
  it('can test HttpClient.post ', () => {
    ...
    service.createProduct(data).subscribe((response) => expect(response).toBeNull());
    const req = backEnd.expectOne(url + `/products`);
  ...
  it('can test HttpClient.delete ', () => {
    const id = 1;
    service.deleteProduct(id).subscribe((response) => expect(response).toBeNull());
  ...
  it('can test HttpClient.patch ', () => {
    ...
    const id = 1;
    service.updateProduct(data, id).subscribe((response) => {
